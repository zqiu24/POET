# The following code is adapted from the official GitHub repository: 
# "Optimization on Stiefel Manifold via Cayley Transform" by Jun Li, Yong Zhang, Kui Jia, and David Zhang
# Available at: https://github.com/JunLi-Galios/Optimization-on-Stiefel-Manifold-via-Cayley-Transform/blob/master/stiefel_optimizer.py
